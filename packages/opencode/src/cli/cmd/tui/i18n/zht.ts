...
export const dict = {
  ...
  "tui.command.never_ask.title_on": "跳過提問：開 - 點此關閉（恢復正常提問）",
  "tui.command.never_ask.title_off": "跳過提問：關 - 點此開啟（不再提問，自行決策）",
  "tui.command.never_ask.toast_on":
    "已開啟跳過提問 — 我不會再向你提問，會自行選擇最佳選項，直到你關閉（/never-ask-questions）。權限請求仍需你確認。",
