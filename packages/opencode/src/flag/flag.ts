...
export const Flag = {
  ...
  MIMOCODE_EXPERIMENTAL_DEFER_BUILTIN_TOOLS: truthy("MIMOCODE_EXPERIMENTAL_DEFER_BUILTIN_TOOLS"),
  MIMOCODE_EXPERIMENTAL_DISABLE_BUILTIN_TOOLS: truthy("MIMOCODE_EXPERIMENTAL_DISABLE_BUILTIN_TOOLS"),
  MIMOCODE_EXPERIMENTAL_BUILTIN_TOOL_ALLOWLIST: process.env["MIMOCODE_EXPERIMENTAL_BUILTIN_TOOL_ALLOWLIST"],
  MIMOCODE_EXPERIMENTAL_DISABLE_MCP_TOOLS: truthy("MIMOCODE_EXPERIMENTAL_DISABLE_MCP_TOOLS"),
  MIMOCODE_EXPERIMENTAL_MCP_TOOL_ALLOWLIST: process.env["MIMOCODE_EXPERIMENTAL_MCP_TOOL_ALLOWLIST"],
